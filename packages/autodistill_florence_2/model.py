...
class Florence2(DetectionBaseModel):
    ...
    def predict(self, input: str, confidence: int = 0.5) -> sv.Detections:
        ...
        detections = sv.Detections(
            ...
            # TODO: Florence-2 doesn't provide per-detection confidence scores.
            # Consider using IOU with ground truth or implementing a secondary
            # confidence estimation method if confidence filtering is needed.
            confidence=np.array(
                [
                    1.0
                    for box, label in boxes_and_labels
